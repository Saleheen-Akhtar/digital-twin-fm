  ...
  return (
    <group position={position}>
      ...
      <mesh position={[-0.28, 0.6, 0]} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#8a9baa" roughness={0.35} metalness={0.75} />
      </mesh>
      <mesh position={[0.28, 0.6, 0]} castShadow receiveShadow>
        <cylinderGeometry args={[0.34, 0.34, 1.3, 24]} />
        <meshStandardMaterial color="#9db0c2" roughness={0.3} metalness={0.8} />
      </mesh>
      {/* Base Frame */}
      <mesh position={[0, 0.06, 0]} castShadow receiveShadow>
        <boxGeometry args={[1.24, 0.12, 0.86]} />
        <meshStandardMaterial color="#a0b0c0" roughness={0.7} metalness={0.3} />
      </mesh>
      {/* Control Panel */}
      <mesh position={[-0.42, 0.46, 0.32]}>
        <boxGeometry args={[0.1, 0.34, 0.24]} />
        <meshStandardMaterial color="#1e293a" roughness={0.4} metalness={0.1} />
      </mesh>
      {/* Display Screen */}
      ...
      <mesh position={[0, 0.34, 0.38]}>
        ...
        <meshStandardMaterial color="#b85a30" roughness={0.6} metalness={0.4} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position}>
      ...
      <mesh position={[0, 0.74, 0]} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#506376" roughness={0.45} metalness={0.65} />
      </mesh>
      {/* Retaining Rings */}
      {[-0.45, -0.22, 0, 0.22, 0.45].map((y, i) => (
        <mesh key={i} position={[0, 0.74 + y, 0]}>
        <cylinderGeometry args={[0.67, 0.67, 0.015, 22]} />
        <meshStandardMaterial color="#7a8fa3" roughness={0.4} metalness={0.7} />
        </mesh>
      ))}
      {/* Base Stand */}
      <mesh position={[0, -0.06, 0]} castShadow>
        <boxGeometry args={[1.5, 0.12, 0.8]} />
        <meshStandardMaterial color="#8a9aaa" roughness={0.7} metalness={0.3} />
      </mesh>
      {/* Firebox Door (front) */}
      <mesh position={[0, 0.48, 0.67]}>
        <circleGeometry args={[0.3, 16]} />
        <meshStandardMaterial color="#2c3d4b" roughness={0.6} metalness={0.8} />
      </mesh>
      {/* Relief Valve */}
      <mesh position={[0, 1.2, 0]}>
        <cylinderGeometry args={[0.06, 0.08, 0.14, 8]} />
        <meshStandardMaterial color="#c93838" roughness={0.5} metalness={0.3} />
      </mesh>
      {/* Exhaust Flue */}
      <mesh position={[-0.3, 1.24, -0.2]}>
        <cylinderGeometry args={[0.04, 0.06, 0.22, 8]} />
        <meshStandardMaterial color="#3a4c5e" roughness={0.5} metalness={0.6} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position}>
      ...
      <mesh position={[0, -0.04, 0]} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#b0bcc8" roughness={0.9} metalness={0.02} />
      </mesh>
      {/* Pump Volute */}
      <mesh position={[-0.12, 0.18, 0]} castShadow receiveShadow>
        <sphereGeometry args={[0.22, 16, 16]} />
        <meshStandardMaterial color="#5b6d7e" roughness={0.4} metalness={0.6} />
      </mesh>
      {/* Motor Housing */}
      <mesh position={[0.28, 0.22, 0]} castShadow receiveShadow>
        <cylinderGeometry args={[0.16, 0.18, 0.34, 14]} />
        <meshStandardMaterial color="#889aaa" roughness={0.5} metalness={0.3} />
      </mesh>
      {/* Motor cooling fins */}
      {[0.15, 0.2, 0.25, 0.3, 0.35].map((y, i) => (
        <mesh key={i} position={[0.28, y, 0.18]}>
        <boxGeometry args={[0.02, 0.012, 0.05]} />
        <meshStandardMaterial color="#5c6f80" roughness={0.4} metalness={0.7} />
        </mesh>
      ))}
      {/* Inlet Flange */}
      <mesh position={[-0.3, 0.18, 0]}>
        <cylinderGeometry args={[0.08, 0.1, 0.04, 12]} />
        <meshStandardMaterial color="#798b9c" roughness={0.3} metalness={0.6} />
      </mesh>
      {/* Outlet Flange */}
  ...
  return (
    <group position={position}>
      ...
      <mesh castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#889aaa" roughness={0.5} metalness={0.4} />
      </mesh>
      {/* Impeller (rotating) */}
      <mesh ref={rotorRef} position={[0, 0, 0.04]}>
        <boxGeometry args={[0.6, 0.04, 0.06]} />
        <meshStandardMaterial color="#98aec2" roughness={0.3} metalness={0.8} />
      </mesh>
      ...
      <mesh position={[0, 0, 0.06]}>
        ...
        <meshStandardMaterial color="#1f2d39" roughness={0.5} metalness={0.6} />
      </mesh>
      {/* Safety guard (cage) */}
      <mesh position={[0, 0, 0.18]}>
        <ringGeometry args={[0.14, 0.42, 22]} />
        <meshStandardMaterial color="#76899a" roughness={0.4} metalness={0.3} side={THREE.DoubleSide} transparent opacity={0.35} wireframe />
      </mesh>
      {/* Mounting bracket */}
      <mesh position={[0, -0.24, 0]}>
        <boxGeometry args={[0.54, 0.08, 0.12]} />
        <meshStandardMaterial color="#889aaa" roughness={0.6} metalness={0.3} />
      </mesh>
    </group>
  );
}
    ...
    <group position={position}>
      ...
      {[-0.86, 0.86].map((x, i) => (
        <mesh key={i} position={[x, 1.8, 0]}>
          ...
          <meshStandardMaterial color="#8a9db0" roughness={0.3} metalness={0.85} />
        </mesh>
      ))}
      {/* Cab */}
      <group ref={cabRef} position={[0, 1.6, 0]}>
        ...
        <mesh position={[0, 0.7, 0.72]}>
          ...
          <meshStandardMaterial color="#1d2b36" />
        </mesh>
        {/* Top trim */}
        ...
        {[-0.5, 0.5].map((x, i) => (
          ...
          <meshStandardMaterial color="#3a4d5e" roughness={0.5} metalness={0.8} />
          </mesh>
        ))}
      </group>
    </group>
  ...
  return (
    <group position={position}>
      ...
      <mesh position={[0, 0.54, 0]} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#7a8a9a" roughness={0.5} metalness={0.4} />
      </mesh>
      {/* Radiator cooling fins */}
      {[-0.38, -0.19, 0, 0.19, 0.38].map((x, i) => (
        <mesh key={i} position={[x, 0.6, 0.31]}>
        <boxGeometry args={[0.012, 0.6, 0.14]} />
        <meshStandardMaterial color="#5a6b7a" roughness={0.4} metalness={0.7} />
        </mesh>
      ))}
      ...
      {[-0.18, 0.18].map((x, i) => (
        ...
        <meshStandardMaterial color="#d4dce8" roughness={0.6} metalness={0.05} />
        </mesh>
      ))}
      {/* Coil top */}
      ...
      <mesh position={[0, 0.02, 0]} castShadow>
        ...
        <meshStandardMaterial color="#1f2d39" roughness={0.7} metalness={0.4} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group position={position}>
      ...
      <mesh position={[0, -0.08, 0]} castShadow>
        ...
        <meshStandardMaterial color="#889898" roughness={0.6} metalness={0.5} />
      </mesh>
  ...
  return (
    <group position={position}>
      ...
      <mesh>
        ...
        <meshStandardMaterial color="#bfceda" roughness={0.55} metalness={0.45} />
      </mesh>
      {/* Louver slats */}
      {[-0.15, -0.07, 0, 0.07, 0.15].map((x, i) => (
        <mesh key={i} position={[x, -0.015, 0]}>
          <boxGeometry args={[0.04, 0.01, 0.36]} />
          <meshStandardMaterial color="#7a8a9a" roughness={0.6} metalness={0.5} />
        </mesh>
      ))}
    </group>
  );
